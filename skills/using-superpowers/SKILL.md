...
**In Codex CLI:** Skills are discovered from the configured skills directory. Open the target `SKILL.md` directly and follow it.
...
digraph skill_flow {
    ...
    "Create task checklist per item" [shape=box];
    ...
    "Has checklist?" -> "Create task checklist per item" [label="yes"];
    "Has checklist?" -> "Follow skill exactly" [label="no"];
    "Create task checklist per item" -> "Follow skill exactly";
}
```
