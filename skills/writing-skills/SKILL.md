...
**Purpose:** The active coding agent reads description text to decide which skills to load for a task. Make it answer: "Should I read this skill right now?"
...
**IMPORTANT: Create a checklist with one task for EACH item below.**
