...
from src.utils import safe_float, coerce_ticker

def load_saved_watchlist(*args, **kwargs):
    from src.stage_04_pipeline.batch_funnel import load_saved_watchlist as _impl
    return _impl(*args, **kwargs)

def load_latest_snapshot_for_ticker(*args, **kwargs):
