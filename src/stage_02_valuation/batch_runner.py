...
def value_single_ticker(ticker: str) -> dict | None:
    try:
        ...
        row = {
            ...
            "default_resolution_json": json.dumps(getattr(inputs, "default_resolution", {}) or {}, separators=(",", ":")),
            ...
            "public_comps_fallback_used": bool(ciq.get("public_comps_fallback_used")),
            "public_comps_fallback_source_file": ciq.get("public_comps_fallback_source_file"),
            "public_comps_fallback_peer_count": ciq.get("public_comps_fallback_peer_count"),
