...
Entry point: `python -m screening.stage1_filter`
...
Core filters in `screening/stage1_filter.py`:
...
Entry point: `python -m src.valuation.batch_runner --top 50`
...
Judgment agents (`src/agents/`) consume deterministic outputs and external text context.
